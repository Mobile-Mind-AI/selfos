...
def test_create_goal(client):
    ...
    print(f"🔍 get_current_user in overrides: {get_current_user in app.dependency_overrides}")
...
def test_get_goal(client):
    ...
    assert create_response.status_code == 201, f"Failed to create goal: {create_response.text}"

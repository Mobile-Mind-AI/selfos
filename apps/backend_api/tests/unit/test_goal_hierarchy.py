...
from models import Goal, User, LifeArea
...
class TestGoalHierarchy:
    ...
    def test_get_goal_children(self, mock_get_goal_children):
        ...
        # Verify method was called with correct parameters
        mock_get_goal_children.assert_called_once_with(self.mock_db, self.user_id, parent_id)
    ...
    def test_get_goal_descendants_single_level(self, mock_get_goal_children):
        ...
        # Test
        result = goal_service.get_goal_descendants(self.mock_db, self.user_id, parent_id)
    ...
    def test_move_goal_prevents_cycle(self):
        ...
        with pytest.raises(ValueError, match="Moving goal would create a cycle in hierarchy"):

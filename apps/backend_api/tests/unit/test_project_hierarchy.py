...
from models import Project, User, LifeArea
...
class TestProjectHierarchy:
    ...
    def test_get_project_children(self):
        ...
        # Test
        result = project_service.get_project_children(self.mock_db, self.user_id, parent_id)
    ...
    def test_get_project_descendants_single_level(self):
        ...
        # Test
        result = project_service.get_project_descendants(self.mock_db, self.user_id, parent_id)

...
def db_session(isolated_test_setup):
    """Create a database session for avatar tests"""
...
class TestAvatarUpload:
    ...
    def test_upload_avatar_success(self, client, db_session):
        ...
        assert avatar.user_id == "test_user_123"
    ...
    def test_upload_avatar_invalid_file_type(self, client, db_session):
    ...
    def test_upload_avatar_large_file(self, client, db_session):
...
class TestAvatarRetrieval:
    ...
    def test_list_user_avatars(self, client, db_session):
    ...
    def test_get_avatar_image(self, client, db_session):
    ...
    def test_get_avatar_base64(self, client, db_session):
    ...
    def test_get_nonexistent_avatar(self, client, db_session):
    ...
    def test_get_other_user_avatar(self, client, db_session):
...
class TestAvatarManagement:
    ...
    def test_delete_avatar(self, client, db_session):
    ...
    def test_restore_avatar(self, client, db_session):
    ...
    def test_usage_tracking(self, client, db_session):
...
class TestImageProcessing:
    ...
    def test_rgba_to_rgb_conversion(self, client, db_session):

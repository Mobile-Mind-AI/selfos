...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "selected_life_areas", sa.JSON(), nullable=False, server_default="[]"
        ),
    ...
    # Create indexes
    op.create_index(
        op.f("ix_onboarding_states_id"), "onboarding_states", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_onboarding_states_completed"),
        "onboarding_states",
        ["onboarding_completed"],
        unique=False,
    )
    op.create_index(
        op.f("ix_onboarding_states_last_activity"),
        "onboarding_states",
        ["last_activity"],
        unique=False,
    )
...
def downgrade() -> None:
    # Drop indexes
    op.drop_index(
        op.f("ix_onboarding_states_last_activity"), table_name="onboarding_states"
    )
    op.drop_index(
        op.f("ix_onboarding_states_completed"), table_name="onboarding_states"
    )

...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_onboarding_state_activity'), table_name='onboarding_states')
    op.drop_index(op.f('ix_onboarding_state_completed'), table_name='onboarding_states')
    op.drop_index(op.f('ix_onboarding_state_user'), table_name='onboarding_states')
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_onboarding_analytics_event'), table_name='onboarding_analytics')
    op.drop_index(op.f('ix_onboarding_analytics_user_id'), table_name='onboarding_analytics')
    op.drop_table('onboarding_analytics')
    op.drop_index(op.f('ix_avatar_images_id'), table_name='avatar_images')
    op.drop_index(op.f('ix_avatar_images_user_active'), table_name='avatar_images')
    op.drop_index(op.f('ix_avatar_images_user_created'), table_name='avatar_images')
    ...
    op.drop_index(op.f('ix_custom_life_areas_priority'), table_name='custom_life_areas')
    op.drop_index(op.f('ix_custom_life_areas_user_id'), table_name='custom_life_areas')
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['life_area_id'], ['life_areas.id'], name='tasks_life_area_id_fkey'),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='tasks_project_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['users.uid'], name='tasks_user_id_fkey'),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('conversation_logs_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.uid'], name='conversation_logs_user_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='conversation_logs_pkey'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.Column('user_id', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('current_situation', sa.TEXT(), autoincrement=False, nullable=True),
    ...
    sa.Column('work_style', sa.VARCHAR(length=50), autoincrement=False, nullable=True),
    sa.Column('communication_frequency', sa.VARCHAR(length=50), autoincrement=False, nullable=True),
    sa.Column('goal_approach', sa.VARCHAR(length=50), autoincrement=False, nullable=True),
    sa.Column('motivation_style', sa.VARCHAR(length=50), autoincrement=False, nullable=True),
    sa.Column('story_analysis', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
    ...
    sa.Column('custom_answers', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.uid'], name=op.f('personal_profiles_user_id_fkey'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('personal_profiles_pkey')),
    sa.UniqueConstraint('user_id', name=op.f('uq_personal_profiles_user_id'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.uid'], name='assistant_profiles_user_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='assistant_profiles_pkey'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('project_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['life_area_id'], ['life_areas.id'], name='goals_life_area_id_fkey'),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], name='goals_project_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['users.uid'], name='goals_user_id_fkey'),
    ...
    op.create_table('custom_life_areas',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('icon', sa.VARCHAR(length=50), server_default=sa.text("'category'::character varying"), autoincrement=False, nullable=False),
    sa.Column('color', sa.VARCHAR(length=7), server_default=sa.text("'#6366f1'::character varying"), autoincrement=False, nullable=False),
    sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('keywords', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
    sa.Column('priority_order', sa.INTEGER(), server_default=sa.text('0'), autoincrement=False, nullable=False),
    sa.Column('is_custom', sa.BOOLEAN(), server_default=sa.text('true'), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.uid'], name=op.f('custom_life_areas_user_id_fkey'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('custom_life_areas_pkey'))
    )
    op.create_index(op.f('ix_custom_life_areas_user_id'), 'custom_life_areas', ['user_id'], unique=False)
    op.create_index(op.f('ix_custom_life_areas_priority'), 'custom_life_areas', ['user_id', 'priority_order'], unique=False)
    ...
    sa.Column('width', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('height', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('thumbnail_data', postgresql.BYTEA(), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.uid'], name=op.f('avatar_images_user_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('avatar_images_pkey'))
    )
    op.create_index(op.f('ix_avatar_images_user_created'), 'avatar_images', ['user_id', sa.literal_column('created_at DESC')], unique=False)
    op.create_index(op.f('ix_avatar_images_user_active'), 'avatar_images', ['user_id', 'is_active'], unique=False)
    op.create_index(op.f('ix_avatar_images_id'), 'avatar_images', ['id'], unique=False)
    ...
    sa.Column('step_name', sa.VARCHAR(length=50), autoincrement=False, nullable=True),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.uid'], name=op.f('onboarding_analytics_user_id_fkey'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('onboarding_analytics_pkey'))
    )
    op.create_index(op.f('ix_onboarding_analytics_user_id'), 'onboarding_analytics', ['user_id'], unique=False)
    op.create_index(op.f('ix_onboarding_analytics_event'), 'onboarding_analytics', ['event_type', 'created_at'], unique=False)
    ...
    sa.Column('assistant_profile_id', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('selected_life_areas', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('first_goal_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('first_task_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('temp_data', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('skip_intro', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('theme_preference', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('started_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('completed_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('last_activity', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('personal_story', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
    sa.Column('preference_learning', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
    sa.Column('context_config', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
    sa.Column('flow_version', sa.VARCHAR(length=10), server_default=sa.text("'v1'::character varying"), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['assistant_profile_id'], ['assistant_profiles.id'], name=op.f('onboarding_states_assistant_profile_id_fkey')),
    sa.ForeignKeyConstraint(['first_goal_id'], ['goals.id'], name=op.f('onboarding_states_first_goal_id_fkey')),
    sa.ForeignKeyConstraint(['first_task_id'], ['tasks.id'], name=op.f('onboarding_states_first_task_id_fkey')),
    sa.ForeignKeyConstraint(['user_id'], ['users.uid'], name=op.f('onboarding_states_user_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('onboarding_states_pkey')),
    sa.UniqueConstraint('user_id', name=op.f('onboarding_states_user_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_index(op.f('ix_onboarding_states_id'), 'onboarding_states', ['id'], unique=False)
    op.create_index(op.f('ix_onboarding_state_user'), 'onboarding_states', ['user_id'], unique=False)
    op.create_index(op.f('ix_onboarding_state_completed'), 'onboarding_states', ['onboarding_completed', sa.literal_column('completed_at DESC')], unique=False)
    op.create_index(op.f('ix_onboarding_state_activity'), 'onboarding_states', [sa.literal_column('last_activity DESC')], unique=False)

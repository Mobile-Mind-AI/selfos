...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_entity_types_is_system", "entity_types", ["is_system"], unique=False
    )
    op.create_index(
        "ix_entity_types_user_name", "entity_types", ["user_id", "name"], unique=False
    )
    ...
    op.create_index(
        "ix_entities_external",
        "entities",
        ["external_source", "external_id"],
        unique=False,
    )
    op.create_index(
        "ix_entities_user_created", "entities", ["user_id", "created_at"], unique=False
    )
    op.create_index(
        "ix_entities_user_name", "entities", ["user_id", "name"], unique=False
    )
    op.create_index(
        "ix_entities_user_type", "entities", ["user_id", "entity_type_id"], unique=False
    )
    ...
    op.create_index(
        "ix_goal_entities_entity", "goal_entities", ["entity_id"], unique=False
    )
    ...
    op.create_index(
        "ix_project_entities_entity", "project_entities", ["entity_id"], unique=False
    )
    op.create_index(
        "ix_project_entities_project", "project_entities", ["project_id"], unique=False
    )
    ...
    op.create_index(
        "ix_task_entities_entity", "task_entities", ["entity_id"], unique=False
    )

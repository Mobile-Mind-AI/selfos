...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_life_areas_user_created",
        "life_areas",
        ["user_id", sa.text("created_at DESC")],
        unique=False,
    )
    op.create_index(
        "ix_life_areas_user_name", "life_areas", ["user_id", "name"], unique=False
    )
    ...
    op.create_index(
        "ix_goals_life_area_created",
        "goals",
        ["life_area_id", sa.text("created_at DESC")],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_media_attachments_id"), "media_attachments", ["id"], unique=False
    )
    op.create_index(
        "ix_media_goal",
        "media_attachments",
    ...
    op.create_index(
        "ix_memory_user_created",
        "memory_items",
        ["user_id", sa.text("created_at DESC")],
        unique=False,
    )
    op.create_index(
        "ix_memory_user_type", "memory_items", ["user_id", "memory_type"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_story_sessions_id"), "story_sessions", ["id"], unique=False
    )
    op.create_index(
        "ix_story_user_created",
        "story_sessions",
        ["user_id", sa.text("created_at DESC")],
        unique=False,
    )
    op.create_index(
        "ix_story_user_type", "story_sessions", ["user_id", "story_type"], unique=False
    )

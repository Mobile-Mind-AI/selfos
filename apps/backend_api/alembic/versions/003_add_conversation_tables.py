...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "conversation_turn", sa.Integer(), nullable=False, server_default="1"
        ),
        sa.Column("previous_intent", sa.String(), nullable=True),
        sa.Column(
            "user_context", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_conversation_logs_id"), "conversation_logs", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        ...
        "conversation_logs",
        ["intent", sa.text("confidence DESC")],
        unique=False,
    )
    op.create_index(
        "ix_conversation_logs_fallback",
        "conversation_logs",
        ["fallback_used", sa.text("created_at DESC")],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "successful_intents", sa.Integer(), nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        ...
        "conversation_sessions",
        ["user_id", sa.text("last_activity DESC")],
        unique=False,
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_intent_feedback_id"), "intent_feedback", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        ...
        "intent_feedback",
        ["original_intent", "feedback_type"],
        unique=False,
    )
    op.create_index(
        "ix_intent_feedback_quality",
        "intent_feedback",
        ["feedback_quality", sa.text("created_at DESC")],
        unique=False,
    )

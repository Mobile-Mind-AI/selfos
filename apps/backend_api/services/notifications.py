...
async def send_completion_notification(
    ...
    try:
        ...
        logger.info(
            f"Sent completion notifications for task '{task_title}' to user {user_id}"
        )
...
async def _generate_completion_notification(
    ...
    return {"title": title, "body": body, "emoji": emoji}
...
async def _send_push_notification(
    ...
    try:
        ...
        logger.info(
            f"[PUSH] To {user_id}: {notification['title']} - {notification['body']}"
        )
...
async def _send_email_notification(
    ...
    try:
        ...
        logger.info(
            f"[EMAIL] To {user_id}: {notification['title']} - {notification['body']}"
        )
...
async def send_goal_completion_notification(
    ...
    try:
        ...
        logger.info(
            f"Sent goal completion notifications for '{goal_title}' to user {user_id}"
        )
...
async def send_weekly_summary_notification(
    ...
    try:
        ...
        return {"success": True, "notifications_sent": len(results), "results": results}

...
class SecuritySettings(BaseSettings):
    ...
    jwt_access_token_expire_minutes: int = Field(default=1440, env="JWT_ACCESS_TOKEN_EXPIRE_MINUTES")  # 24 hours
...
class AISettings(BaseSettings):
    ...
    vector_db_provider: str = Field(default="local", env="VECTOR_DB_PROVIDER")  # local, pinecone, weaviate
    ...
    memory_max_content_length: int = Field(default=2000, env="MEMORY_MAX_CONTENT_LENGTH")

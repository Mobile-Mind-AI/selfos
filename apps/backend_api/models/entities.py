...
from .associations import goal_entities, project_entities, task_entities
...
class EntityType(Base):
    ...
    entities = relationship(
        "Entity", back_populates="entity_type", cascade="all, delete-orphan"
    )
...
class EntityRelationship(Base):
    ...
    )  # e.g., "works_at", "located_in", "reports_to"

    # Optional metadata about the relationship
    properties = Column(
        JSON, nullable=False, default=dict
    )  # e.g., {"since": "2020", "role": "CEO"}

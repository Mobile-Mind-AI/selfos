...
class ConversationSession(Base):
    ...
    )  # general, onboarding, goal_setting, etc.
    title = Column(
...
class IntentFeedback(Base):
    ...
    conversation_log_id = Column(
        String, ForeignKey("conversation_logs.id"), nullable=False
    )
    ...
    feedback_type = Column(
        Enum("correct", "incorrect", "partially_correct", name="intent_feedback_type"),
        nullable=False,
    )
...
Index(
    "ix_conversation_logs_user_created",
    ConversationLog.user_id,
    ConversationLog.created_at.desc(),
)
Index(
    "ix_conversation_logs_session_turn",
    ConversationLog.session_id,
    ConversationLog.conversation_turn,
)
Index(
    "ix_conversation_logs_intent_confidence",
    ConversationLog.intent,
    ConversationLog.confidence.desc(),
)
Index(
    "ix_conversation_logs_fallback",
...
Index(
    "ix_intent_feedback_user_created",
    IntentFeedback.user_id,
    IntentFeedback.created_at.desc(),
)
Index(
    "ix_intent_feedback_original_intent",
    IntentFeedback.original_intent,
    IntentFeedback.feedback_type,
)
Index(
    "ix_intent_feedback_quality",
    IntentFeedback.feedback_quality,
    IntentFeedback.created_at.desc(),
)

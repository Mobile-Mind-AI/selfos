...
class UserPreferences(Base):
    ...
    tone = Column(
        Enum("friendly", "coach", "minimal", "professional", name="tone_style"),
        default="friendly",
    )
    ...
    default_view = Column(
        Enum("list", "card", "timeline", name="view_mode"), default="card"
    )
...
Index(
    "ix_user_prefs_history_user_time",
    UserPreferencesHistory.user_id,
    UserPreferencesHistory.changed_at.desc(),
)

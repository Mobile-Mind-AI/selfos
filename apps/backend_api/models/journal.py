...
class JournalEntry(Base):
    ...
    # Entry metadata
    entry_type = Column(String, nullable=False, default="reflection")  # reflection, daily, goal_review, gratitude
    ...
    extracted_entities = Column(JSON, nullable=True)  # Extracted people, places, concepts
    sentiment_score = Column(JSON, nullable=True)  # {"positive": 0.7, "negative": 0.1, "neutral": 0.2}
    key_themes = Column(JSON, nullable=True)  # ["productivity", "relationships", "health"]

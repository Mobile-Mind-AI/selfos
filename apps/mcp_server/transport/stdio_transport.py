...
class StdioTransport:
    ...
    async def start(self):
        ...
        try:
            ...
            self.writer = asyncio.StreamWriter(sys.stdout, protocol, self.reader, loop)
    ...
    async def _send_message(self, message: dict):
        ...
        try:
            ...
            logger.debug(
                f"Sent message: {message.get('method', message.get('result', 'response'))}"
            )
    ...
    async def _handle_initialize(self, params: dict) -> dict:
        ...
        return {
            ...
            "serverInfo": {"name": "selfos-mcp-server", "version": "1.0.0"},
            "capabilities": {

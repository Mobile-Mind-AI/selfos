...
from config import MCPConfig, SecurityConfig, TransportConfig
...
class TestMCPConfig:
    ...
    def test_configuration_validation(self):
        ...
        # Valid configuration (disable auth for test)
        valid_config = MCPConfig()
        valid_config.security.require_authentication = False
        ...
        assert any(
            "max_concurrent_connections must be positive" in error for error in errors
        )

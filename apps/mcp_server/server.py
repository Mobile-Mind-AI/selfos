...
class SelfOSMcpServer:
    ...
    def __init__(self, config: MCPConfig | None = None):
        ...
        # self.onboarding_tools = OnboardingToolsHandler()  # TODO: Create when needed
            ...
            return [
                    ...
                    arguments=[
                        {
                            ...
                            "description": "The goal to decompose",
                            "required": True,
                        },
                        {
                            "name": "context",
                    ...
                    arguments=[
                        {
                            ...
                            "description": "The project to structure",
                            "required": True,
                        },
                        {
                            "name": "user_preferences",
                            "description": "User's working preferences",
                            "required": False,
                        },
                    ],
                ),
                Prompt(
                    ...
                    arguments=[
                        ...
                        {
                            "name": "date",
                            "description": "Target date for planning",
                            "required": False,
                        },
                    ],
                ),
